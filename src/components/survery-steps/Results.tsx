...
export function ResultsStep({ income, goal, affordableCars, affordableHomes, isLoading }: ResultsStepProps) {
  return (
    <>
      <h1 className="text-3xl font-bold text-center mt-8 mb-10 font-Playfair">Results</h1>
      <p className="text-lg text-center mb-6">
        Based on your annual income of ${Number(income).toLocaleString()}, you can afford:
      </p>
      <div className="space-y-6">
        <p className="text-xl font-semibold capitalize">
          {goal}: Up to ${calculateAffordableAmount(goal, income).toLocaleString()}
        </p>
        ...
        {goal === "car" && (
          <div className="mt-8">
            ...
            {isLoading ? (
              <div className="text-center py-4">Loading car recommendations...</div>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                          <p className="text-lg font-semibold text-emerald-600">{car.price}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        {goal === "house" && (
          <div className="mt-8">
            <h2 className="text-xl font-semibold mb-4">Where you could live:</h2>
            {isLoading ? (
              <div className="text-center py-4">Loading home recommendations...</div>
                  ...
                  <Card key={home.regionid} className="overflow-hidden">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-medium text-lg">
                            {home.regionName}, {home.stateName}
                          </h3>
